package com.stepasha.artportfolio.logging;
...
{
    @Around(value = "@within(com.stepasha.artportfolio.logging.Loggable) || @annotation(com.stepasha.artportfolio.logging.Loggable)")
